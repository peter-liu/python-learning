...
3*.Line structure (program is divided into a number of logic lines)
    ...
    3.2 physical lines
            is a sequence of characters terminated by an end-of-line sequence(different by os), but all of those forms can used equally, regardless of platform.
            because source code passed to pythons APIs using the standard C conventions for new line(\n | ASCII LF)
    3.3 comment
